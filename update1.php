...
<body>
    ...
    if($total!=0)
    {
        while($result=mysqli_fetch_assoc($data))
        {
            ...
            <td><a href='update2.php?pno=$result[pno]&fn=$result[f_name]&mn=$result[m_name]&ln=$result[l_name]&db=$result[dob]&na=$result[nation]&addr=$result[address]&gen=$result[gender]'>Update</a></td>
